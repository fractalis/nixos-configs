...
---Helps prevent from running into indexing errors without a nixCats plugin from nix.
---If loaded via Nix, it does nothing.
---non_nix_value default to true if not provided or is not a boolean
